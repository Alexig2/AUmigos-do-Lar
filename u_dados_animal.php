        ...
        <div class="row g-0">
            <div class="col-md-4">
                ...
                <div class="ms-2 d-flex flex-column">
                    ...
                    <a href="u_ver_ong.php?ong_codigo=<?= $ong_codigo ?>"><label class="card-text"><small><?= $nome_fantasia ?></small></label></a>
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-primary" onclick="window.location.href='u_adotando.php?animal_codigo=<?= $animal_codigo ?>'">Adotar</button>
                    </div>
                </div>
            </div>
        </div>
