...
$sql = "SELECT U.nome nome_usuario, A.nome nome_animal, data_adocao, adocao_codigo
    ...
    <div class="row">
      <div class="col-12">
        <div class="row card-body fs-4">
          <h1 class="text-center mb-3 titulo1">Histórico de Adoção</h1>
          <hr>
          <br>
          <div class="col-6">
              ...
              <div>
                ...
                ?>
                  <a href="o_dados_adocao.php?adocao_codigo=<?= $adocao_codigo ?>" class="list-group-item list-group-item-action list-group-item-light">
                    <?= $data_adocao ?> - <?= $nome_animal ?> - <?= $nome_usuario ?>
                  </a>
                <?php
                }
                ?>
